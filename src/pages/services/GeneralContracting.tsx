...
const GeneralContracting = () => (
  <ServicePage
    ...
    heroImage="https://muskokaimprovements.ca/wp-content/uploads/2024/01/IMG_3006-scaled.jpg"
    description={[
      "From foundations to finishing touches, Muskoka Improvements provides comprehensive general contracting services across Bracebridge, Huntsville, Gravenhurst, and all of Muskoka.",
    ...
    features={[
      ...
      "Boathouses & waterfront structures",
      "Foundations & framing",
